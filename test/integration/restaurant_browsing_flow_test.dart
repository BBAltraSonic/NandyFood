...
void main() {
  group('Restaurant Browsing Flow Integration Tests', () {
    ...
    test('menu item listing and filtering', () async {
      ...
      updatedRestaurantState = container.read(restaurantProvider);
      expect(
        updatedRestaurantState.filteredMenuItems.length,
    ...
    test('restaurant sorting functionality', () async {
      ...
      for (var i = 1; i < restaurantState.filteredRestaurants.length; i++) {
        expect(
          restaurantState.filteredRestaurants[i - 1].rating,
      ...
      for (var i = 1; i < restaurantState.filteredRestaurants.length; i++) {
        expect(
          restaurantState.filteredRestaurants[i - 1].estimatedDeliveryTime,
          lessThanOrEqualTo(
            restaurantState.filteredRestaurants[i].estimatedDeliveryTime,
          ),
        );
      }
    });
