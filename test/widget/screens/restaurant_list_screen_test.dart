...
void main() {
  group('RestaurantListScreen Widget Tests', () {
    ...
    testWidgets('displays restaurant list correctly', (WidgetTester tester) async {
    ...
    testWidgets('applies dietary restriction filters', (WidgetTester tester) async {
      await tester.pumpWidget(
        ProviderScope(
          child: MaterialApp(
            home: RestaurantListScreen(),
    ...
    testWidgets('navigates to restaurant detail when restaurant card is tapped', (WidgetTester tester) async {
        ...
        ProviderScope(
          child: MaterialApp(
            ...
            onGenerateRoute: (settings) {
              if (settings.name != null && settings.name!.startsWith('/restaurant/')) {
