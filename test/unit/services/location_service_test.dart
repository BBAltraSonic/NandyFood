...
void main() {
  group('LocationService', () {
    ...
    test('checkPermission should return a LocationPermission', () async {
      ...
      expect(
        () async => await locationService.checkPermission(),
        returnsNormally,
      );
    });
    ...
    test('getAddressFromCoordinates should return an address string', () async {
      ...
      expect(
        () async =>
            await locationService.getAddressFromCoordinates(40.7128, -74.0060),
        returnsNormally,
      );
    });
    ...
    test('getNearbyRestaurants should return a list of restaurants', () async {
      ...
      expect(
        () async => await locationService.getNearbyRestaurants(),
        returnsNormally,
      );
    });
  });
