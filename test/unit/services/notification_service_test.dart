...
void main() {
  group('NotificationService', () {
    ...
    test('showNotification should accept required parameters', () async {
      ...
      expect(() async => await notificationService.showNotification(
        id: 1,
        title: 'Test Title',
        body: 'Test Body',
      ), returnsNormally);
    ...
    test('showOrderStatusNotification should accept required parameters', () async {
      expect(() async => await notificationService.showOrderStatusNotification(
        orderId: 'order123',
        status: 'confirmed',
    ...
    test('showDeliveryNotification should accept required parameters', () async {
      expect(() async => await notificationService.showDeliveryNotification(
        orderId: 'order123',
        driverName: 'John Doe',
      ), returnsNormally);
    });

    test('showPromotionalNotification should accept required parameters', () async {
      expect(() async => await notificationService.showPromotionalNotification(
        title: 'Promo Title',
        body: 'Promo Body',
      ), returnsNormally);
    });
    ...
    test('showGeneralNotification should accept required parameters', () async {
      expect(() async => await notificationService.showGeneralNotification(
        title: 'General Title',
        body: 'General Body',
      ), returnsNormally);
    });
