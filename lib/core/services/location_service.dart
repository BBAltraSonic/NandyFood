...
class LocationService {
  ...
  Future<LocationPermission> requestPermissionWithDialog(BuildContext context) async {
  ...
  Future<List<Map<String, dynamic>>> getNearbyRestaurants({double? radiusInKm}) async {
